    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .adm-nav{position:fixed;left:0;right:0;bottom:0;z-index:9998;display:flex;
          background:#111;border-top:1px solid #2a2a2a;padding:6px 8px;gap:4px;
          box-shadow:0 -4px 16px rgba(0,0,0,.25)}
        .adm-nav a{flex:1;display:flex;flex-direction:column;align-items:center;gap:2px;
          padding:6px 4px;border-radius:9px;text-decoration:none;color:#8a8a8a;
          font-size:10px;font-weight:700;font-family:'Plus Jakarta Sans',system-ui,sans-serif}
        .adm-nav a.on{background:rgba(245,200,66,.14);color:#F5C842}
        .adm-nav i{font-size:17px}
      ` }} />
