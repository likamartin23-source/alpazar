    ...
    <div style={{
      ...
      {err ? (
        <>
          ...
          <p style={{ color: '#C42B0F', fontSize: 'var(--fs-dysheme)', fontWeight: 600, maxWidth: 320 }}>{err}</p>
          <p style={{ color: '#555', fontSize: 'var(--fs-dysheme)' }}>Duke të kthyer te hyrja...</p>
        </>
      ) : (
        <>
          <div style={{
          ...
          <p style={{ color: '#555', fontSize: 'var(--fs-dysheme)' }}>Duke u autentikuar...</p>
        </>
      )}
    </div>
  )
