...
.tr b{display:block;font-size:var(--fs-dysheme);font-weight:800;color:#111}
.tr span{display:block;font-size:var(--fs-dysheme);color:#555;margin-top:2px}
...
.hero-s{font-size:var(--fs-dysheme);color:#ddd;line-height:1.55}
.seg{display:flex;gap:6px;background:#f2ecd6;border-radius:999px;padding:4px;margin-bottom:14px}
.sg{flex:1;border:none;background:transparent;border-radius:999px;padding:9px 4px;font-size:var(--fs-dysheme);font-weight:700;cursor:pointer;font-family:inherit;color:#7a6a30;white-space:nowrap;min-height:44px;}
.sg.on{background:#fff;color:#111;box-shadow:0 1px 4px rgba(0,0,0,.08)}
.save{background:#C42B0F;color:#fff;font-size:var(--fs-dysheme);font-weight:800;padding:2px 4px;border-radius:5px;margin-left:3px;vertical-align:middle}
...
.tag{background:var(--az-yellow);color:#111;font-size:var(--fs-dysheme);font-weight:800;padding:2px 6px;border-radius:5px;margin-left:6px;vertical-align:middle}
.p-desc{font-size:var(--fs-dysheme);color:#555;margin-top:3px}
.p-price{text-align:right;white-space:nowrap}
.p-price b{display:block;font-size:19px;font-weight:800;color:#C42B0F}
.p-price span{font-size:var(--fs-dysheme);color:#aaa}
.p-badge{margin-top:8px;display:inline-block;background:#EAF3DE;color:#3B6D11;font-size:var(--fs-dysheme);font-weight:700;padding:3px 8px;border-radius:6px}
.feat-list{list-style:none;margin:10px 0 0;padding:10px 0 0;border-top:.5px solid #f0f0f0}
.feat-list li{font-size:var(--fs-dysheme);color:#444;line-height:1.6;padding-left:17px;position:relative}
...
.sec-t{font-size:var(--fs-dysheme);font-weight:700;color:#111;margin-bottom:10px}
.pm{width:100%;display:flex;align-items:center;gap:9px;border:1.5px solid #e8e8e8;background:#fff;border-radius:10px;padding:11px 12px;margin-bottom:7px;font-size:var(--fs-dysheme);font-weight:600;cursor:pointer;font-family:inherit;color:#333;min-height:44px;}
.pm.on{border-color:var(--az-red);background:#FFF7F5}
.pm .ok{margin-left:auto;color:#C42B0F}
.total{display:flex;justify-content:space-between;align-items:center;padding:11px 2px;margin-top:6px;border-top:.5px solid #eee;font-size:var(--fs-dysheme);color:#666}
...
.center{text-align:center}.muted{color:#555;font-size:var(--fs-dysheme)}.small{font-size:var(--fs-dysheme);margin-top:8px;text-align:center;line-height:1.5}
.note{background:var(--az-cream);border:.5px solid var(--az-yellow);border-radius:9px;padding:10px 12px;font-size:var(--fs-dysheme);color:#5d4a00;margin-bottom:12px;line-height:1.5}
.note.ok{background:#EAF3DE;border-color:#97C459;color:#3B6D11}
.note a{color:#C42B0F;font-weight:700}
.msg{border-radius:10px;padding:9px 13px;font-size:var(--fs-dysheme);font-weight:600;margin-bottom:10px}
