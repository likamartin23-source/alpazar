    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .section-title{font-size:var(--fs-dysheme);font-weight:700;color:#111;margin-bottom:12px;display:flex;align-items:center;gap:6px;}
        ...
        input[type=text],input[type=number],textarea,select{width:100%;border:1.5px solid #e0e0e0;border-radius:12px;padding:10px 13px;font-size:var(--fs-dysheme);font-family:inherit;outline:none;transition:border .15s;background:#fff;color:#111;}
        ...
        .cond-btn{flex:1;border:1.5px solid #e0e0e0;border-radius:12px;padding:9px;font-size:var(--fs-dysheme);font-weight:600;cursor:pointer;background:#fff;font-family:inherit;color:#555;text-align:center;}
        ...
        .img-zone p{font-size:var(--fs-dysheme);color:#555;}
        ...
        .img-remove{position:absolute;top:-5px;right:-5px;width:18px;height:18px;background:var(--az-red);border:none;border-radius:50%;cursor:pointer;display:flex;align-items:center;justify-content:center;color:#fff;font-size:var(--fs-dysheme);font-weight:700;line-height:1;}
        .cat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;}
        .cat-btn{border:1.5px solid #e0e0e0;border-radius:12px;padding:8px 4px;font-size:var(--fs-dysheme);font-weight:600;cursor:pointer;background:#fff;font-family:inherit;color:#555;text-align:center;display:flex;flex-direction:column;align-items:center;gap:3px;}
