    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .msg-btn{flex:1;background:#111;color:#F5C842;border:none;border-radius:10px;padding:12px;font-size:13px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;font-family:inherit;}
        .msg-btn i{font-size:16px;}
        .share-btn{width:44px;background:#F5C842;border:none;border-radius:10px;cursor:pointer;display:flex;align-items:center;justify-content:center;}
        .share-btn i{font-size:18px;color:#111;}
      ...
      <div className="wrap">
        ...
        {user?.id !== shop.id && (
          <div className="action-row">
            <button className="msg-btn" onClick={sendMessage}>
              <i className="ti ti-message-circle" /> Dërgo Mesazh
            </button>
