...
.seo-sub{font-size:var(--fs-dysheme);color:#666;margin:0 0 20px;line-height:1.5;max-width:68ch;}
...
.seo-city-chip{padding:8px 16px;min-height:44px;display:inline-flex;align-items:center;background:#F7F7F7;border:1px solid #eee;border-radius:999px;font-size:var(--fs-dysheme);color:#333;text-decoration:none;transition:background .15s;}
.seo-city-chip:hover{background:#FDE9E4;color:#C42B0F;}
.seo-empty{padding:34px 16px;text-align:center;background:#fff;border:1px dashed #ddd;border-radius:14px;color:#777;font-size:var(--fs-dysheme);}
.seo-empty a{color:#C42B0F;text-decoration:none;font-weight:600;}
.seo-cta{display:inline-flex;align-items:center;margin-top:20px;padding:11px 22px;min-height:44px;background:var(--az-red);color:#fff;border-radius:10px;font-size:var(--fs-dysheme);font-weight:700;text-decoration:none;}
`
