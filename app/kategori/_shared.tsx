...
.seo-cta{display:inline-flex;align-items:center;margin-top:20px;padding:11px 22px;min-height:44px;background:#E63312;color:#fff;border-radius:10px;font-size:14px;font-weight:700;text-decoration:none;}
`
