  ...
  if (authReady && !user) {
    return (
      <div style={{ minHeight: '100dvh', background: '#FFFBEA', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, padding: 24 }}>
        ...
        <button onClick={() => window.location.href = '/login'} style={{ background: '#F5C842', border: 'none', borderRadius: 12, padding: '12px 28px', fontWeight: 700, fontSize: 15, cursor: 'pointer' }}>
          Kyçu
        </button>
      </div>
    )
