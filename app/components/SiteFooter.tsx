...
const soc = [
  ...
  // X/Twitter — rikthyer me kërkesë të pronarit ("X dhe Twitter të dyja"). SHËNIM: x.com/alpazaral
  // jep ende 404 derisa pronari të hapë profilin @alpazaral; sapo të hapet, lidhja resolvon.
