...
export const CHIP_PREMIUM = chip('linear-gradient(135deg,var(--az-yellow-hi),var(--az-yellow))', '#5A3A00', 'none', '0 1px 4px rgba(245,200,66,.5)')
export const CHIP_VIP     = chip('linear-gradient(135deg,var(--az-yellow),#E8892E)', '#4A2400', 'none', '0 1px 5px rgba(232,137,46,.45)')
