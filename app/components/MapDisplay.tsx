  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 8, display: 'flex', alignItems: 'flex-start', gap: 8, flexWrap: 'wrap' }}>
        {address && (
          <span style={{ fontSize: 'var(--fs-dysheme)', color: '#555', flex: 1 }}>
            <i className="ti ti-map-pin" style={{ fontSize: 'var(--fs-dysheme)', marginRight: 3, color: '#C42B0F' }} aria-hidden="true" />
            {address}
          </span>
        )}
        <a
          ...
          style={{
            ...
            padding: '6px 12px', fontSize: 'var(--fs-dysheme)', fontWeight: 600, textDecoration: 'none', whiteSpace: 'nowrap',
          }}
        >
          <i className="ti ti-map" style={{ fontSize: 'var(--fs-dysheme)' }} aria-hidden="true" />
          Hap në Maps
        </a>
      </div>
    </div>
