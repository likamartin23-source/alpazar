  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .albi-header-status{color:rgba(255,255,255,.7);font-size:var(--fs-dysheme);display:flex;align-items:center;gap:5px;margin-top:2px;}
        .albi-online-dot{width:6px;height:6px;border-radius:50%;background:#4ade80;flex-shrink:0;}
        .albi-clear-btn{background:rgba(255,255,255,.15);border:none;border-radius:8px;padding:7px 12px;min-height:44px;color:#fff;font-size:var(--fs-dysheme);font-weight:600;cursor:pointer;font-family:inherit;display:inline-flex;align-items:center;}
        ...
        .albi-bubble{padding:10px 14px;border-radius:18px;font-size:var(--fs-dysheme);line-height:1.6;max-width:82%;word-break:break-word;}
        ...
        .albi-quick-label{color:#555;font-size:var(--fs-dysheme);font-weight:600;margin-bottom:7px;text-transform:uppercase;letter-spacing:.5px;}
        .albi-quick-grid{display:flex;flex-wrap:wrap;gap:6px;}
        .albi-quick-btn{background:var(--az-ink);border:0.5px solid #2a2a2a;border-radius:20px;padding:7px 13px;min-height:44px;font-size:var(--fs-dysheme);color:#ccc;cursor:pointer;font-family:inherit;transition:all .15s;white-space:nowrap;display:inline-flex;align-items:center;}
        ...
        .albi-input-wrap textarea{border:none;background:transparent;color:#e8e8e8;font-size:var(--fs-dysheme);font-family:inherit;outline:none;flex:1;resize:none;min-height:20px;max-height:100px;line-height:1.5;}
