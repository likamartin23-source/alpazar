...
export function StatusBadge({ status, cape }: { status: string; cape?: boolean }) {
  const map: Record<string, [string, string]> = {
    ...
    canceled: ['Anuluar', '#757575'],
    expired:  ['Skaduar', '#757575'],
  }
  const [label, color] = map[status] || [status, '#757575']
...
.fill{background:linear-gradient(90deg,#F5C842,#E63312);height:100%;transition:width .4s}
.note{background:#FFFBEA;border:.5px solid #F5C842;border-radius:9px;padding:9px 12px;font-size:12px;color:#5d4a00;margin-top:10px}
