...
.center{text-align:center}.muted{color:#555;font-size:var(--fs-dysheme)}
.row{display:flex;justify-content:space-between;align-items:flex-start;gap:8px}
.plan-name{font-size:17px;font-weight:800;color:#111}
.badge{font-size:var(--fs-dysheme);font-weight:700;border:1.5px solid;border-radius:999px;padding:3px 10px;white-space:nowrap}
...
.note{background:var(--az-cream);border:.5px solid var(--az-yellow);border-radius:9px;padding:9px 12px;font-size:var(--fs-dysheme);color:#5d4a00;margin-top:10px}
.note.warn{background:#FFF0EE;border-color:#F09595;color:#a02515}
.btns{display:flex;gap:8px;margin-top:12px;flex-wrap:wrap}
.btn{border:1.5px solid #ddd;background:#fff;border-radius:10px;padding:9px 14px;font-size:var(--fs-dysheme);font-weight:700;cursor:pointer;font-family:inherit;color:#333;min-height:44px;display:inline-flex;align-items:center;justify-content:center;}
...
.btn.small{padding:7px 10px;font-size:var(--fs-dysheme);width:100%;min-height:44px}
...
.pname{font-size:var(--fs-dysheme);font-weight:800;color:#111}
.pprice{font-size:15px;font-weight:800;color:#C42B0F;margin:4px 0}
.cur-tag{font-size:var(--fs-dysheme);font-weight:700;color:#8a6d00;margin-top:8px}
.bank{background:#f8f9fb;border:.5px solid #e3e7ee;border-radius:9px;padding:11px 12px;font-size:var(--fs-dysheme);color:#333;margin-top:10px;display:flex;flex-direction:column;gap:4px}
.bank-t{font-weight:700;color:#111;margin-bottom:2px}
.bank span{color:#555}
.bank code{background:#eef1f6;border-radius:5px;padding:1px 6px;font-size:var(--fs-dysheme)}
.ev{display:flex;justify-content:space-between;font-size:var(--fs-dysheme);padding:7px 0;border-bottom:.5px solid #f2f2f2}
...
select{width:100%;border:1.5px solid #e0e0e0;border-radius:8px;padding:7px;font-size:var(--fs-dysheme);font-family:inherit;background:#fff}
`
