...
export const LISTING_SELECT =
  'id,title,price,currency,condition,city,is_premium,images,video_poster,category_id,created_at,user_id,status,rank_tier,views_count,business_id,business:business_id(id,name,logo_url,is_verified),author:user_id(id,full_name,username,avatar_url,is_premium,trust_score)'
