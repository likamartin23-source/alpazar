...
|---|---|---|---|---|
| 1 | Regres `region` 70 nyje — `fab-label` jashtë landmark-u | TERMINAL | **rregulluar, e pashtyrë** | `T-001`, commit `1948ba7`, degë `fix/region-fab-label` |
| 2 | `scrollable-region-focusable` — 4 nyje / 3 faqe | **i palejuar** | HAPUR | `T-002` |
